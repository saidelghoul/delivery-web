    ...
    <aside style={{
      ...
      {!collapsed && role && (
        <div style={{
          ...
          <div style={{ fontSize: "11px", color: COLORS.text.muted, marginBottom: "4px", fontFamily: "'DM Sans', sans-serif" }}>
            Signed in as
          </div>
          <div style={{ fontSize: "13px", fontWeight: "700", color: COLORS.text.main, fontFamily: "'DM Sans', sans-serif" }}>
            {user?.fullName}
          </div>
          <div style={{
